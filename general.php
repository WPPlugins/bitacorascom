	  ...
	  $paises['ve'] = 'Venezuela';
		...
		<div class="wrap">
			...
			<fieldset class="options">
				...
				<h3>Busqueda</h3>
					  <p>Indica una busqueda en Bitacoras.com para que se puedan a&nacute;adir los ultimos posts que coincidan con los terminos.</p>
					<fieldset>
				...
				<div class="block left">
				<h3>Mi comunidad</h3>
					  <p>Indica cual es tu usuario para que se puedan a&nacute;adir los ultimos posts de tu comunidad.</p>
					<fieldset>
				...
				<div class="block left">
				<h3>Usuario</h3>
					  <p>Indica cual es tu usuario para que se puedan a&nacute;adir los ultimos posts de tus blogs registrados en Bitacoras.com.</p>
					<fieldset>
				...
				<div class="block left">
				<h3>Geo</h3>
	<p>Selecciona un pais e indica una ciudad (opcional) para poder a&nacute;adir las ultimas entradas de esa localizacion.</p>
					<fieldset>
